    ...
    return (
        <div className="main-page-content">
            ...
            <div className="knowledge-container">
                ...
                <div className='knowledge-item'>
                    <PopupButton message='What should one do before and after donation?'
                ...
                <div className='knowledge-item'>
                    <PopupButton message='What does the donation process look like?'
                ...
                <div className='knowledge-item'>
                    <PopupButton message='Who do you help by donating blood?'
