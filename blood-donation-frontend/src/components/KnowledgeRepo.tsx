    ...
    return (
        <div className="main-page-content">
            ...
            <div className="knowledge-container">
                ...
                <div className='knowledge-item'>
                    <PopupButton message='How do blood types work?'
                ...
                <div className='knowledge-item'>
                    <PopupButton message='What are the rarest blood types?'
                ...
                <div className='knowledge-item'>
                    <PopupButton message='What should one do before and after donation?' popupMessage="Before donating blood, remember to hydrate your body and eat a light, fat-free meal. You must not smoke for two hours before the procedure. After the donation, you should not overstrain yourself or stay in stuffy rooms. Provide the body with the carbohydrates it needs to replenish missing blood."/>
                </div>
                <div className='knowledge-item'>
                    <PopupButton message='What does the donation process look like?' popupMessage="The process begins with an basic health examination. The blood donation procedure is painless and usually takes 10 to 90 minutes, depending on the component donated. Blood is drawn from a vein in the elbow. The donor can choose the arm. After it is finished, it is good to rest for several minutes."/>
                </div>
                <div className='knowledge-item'>
                    <PopupButton message='Who do you help by donating blood?' popupMessage="By donating blood you help, among others, victims of accidents, people undergoing complicated surgical operations, people suffering from bone marrow diseases and hemophilia."/>
                </div>
