		...
		<div className="main-page-content">
			...
			<div className="quiz-container">
				<div className="quiz-question" id="question1">
					...
					<ManyRadiobuttonsNoDefault name="ans1" labels={["YES", "NO"]} values={["1", "0"]} ids={["q1y", "q1n"]} />
				</div>
				<div className="quiz-question" id="question2">
					<h2>Do you weight over 50kg?</h2>
					<ManyRadiobuttonsNoDefault name="ans2" labels={["YES", "NO"]} values={["1", "0"]} ids={["q2y", "q2n"]} />
				</div>
				<div className="quiz-question" id="question3">
					<h2>Did you get a tatoo recently?</h2>
					<ManyRadiobuttonsNoDefault name="ans3" labels={["YES", "NO"]} values={["0", "1"]} ids={["q3y", "q3n"]} />
				</div>
				<div className="quiz-question" id="question4">
					<h2>Does your blood pressure exceed 180/100 mmHg?</h2>
					<ManyRadiobuttonsNoDefault name="ans4" labels={["YES", "NO"]} values={["0", "1"]} ids={["q4y", "q4n"]} />
				</div>
				<div className="quiz-question" id="question5">
					...
					<ManyRadiobuttonsNoDefault name="ans5" labels={["YES", "NO"]} values={["0", "1"]} ids={["q5y", "q5n"]} />
				</div>
				<div className="quiz-question" id="question6">
					<h2>Have you been to the dentist in the last 7 days?</h2>
					<ManyRadiobuttonsNoDefault name="ans6" labels={["YES", "NO"]} values={["0", "1"]} ids={["q6y", "q6n"]} />
				</div>
				<div className="quiz-question" id="question7">
					<h2>Do you have diabetes or epilepsy</h2>
					<ManyRadiobuttonsNoDefault name="ans7" labels={["YES", "NO"]} values={["0", "1"]} ids={["q7y", "q7n"]} />
				</div>
				<div className="quiz-question" id="question8">
					...
					<ManyRadiobuttonsNoDefault name="ans8" labels={["YES", "NO"]} values={["0", "1"]} ids={["q8y", "q8n"]} />
				</div>
				<div className="quiz-question" id="question9">
					<h2>Have you been treated with a growth hormone?</h2>
					<ManyRadiobuttonsNoDefault name="ans9" labels={["YES", "NO"]} values={["0", "1"]} ids={["q9y", "q9n"]} />
				</div>
				<div className="quiz-question" id="question10">
					<h2>Are you between 18 and 65 years old?</h2>
					<ManyRadiobuttonsNoDefault name="ans10" labels={["YES", "NO"]} values={["1", "0"]} ids={["q10y", "q10n"]} />
				</div>
				<div className="quiz-question" id="question11">
					<h2>Have you been exposed to mad cow disease?</h2>
					<ManyRadiobuttonsNoDefault name="ans11" labels={["YES", "NO"]} values={["0", "1"]} ids={["q11y", "q11n"]} />
				</div>
