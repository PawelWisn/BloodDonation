# Generated by Django 3.1.1 on 2020-11-01 16:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('region', models.CharField(max_length=64, primary_key=True, serialize=False)),
                ('volume', models.IntegerField(default=0)),
                ('group', models.CharField(choices=[('0_P', '0_P'), ('0_N', '0_N'), ('A_P', 'A_P'), ('A_N', 'A_N'), ('B_N', 'B_N'), ('B_P', 'B_P'), ('AB_N', 'AB_N'), ('AB_P', 'AB_P')], max_length=4)),
            ],
        ),
        migrations.CreateModel(
